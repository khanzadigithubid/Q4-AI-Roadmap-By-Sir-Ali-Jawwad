...
app = FastAPI(
    title="My FastAPI Chatbot",
    description="An API for handling chatbot interactions built with FastAPI",
    version="1.0.0",
)
...
@app.get("/")
async def root():
    return {"message": "Welcome to My FastAPI Chatbot! Visit /docs to explore the chatbot interaction API."}
